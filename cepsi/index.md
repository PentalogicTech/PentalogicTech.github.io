...
**URL:** *[https://pacs.cepsi.gob.ar/api/study/getstudyurl.php](https://pacs.cepsi.gob.ar/api/study/getstudyurl.php)*
...
**URL:** *[https://pacs.cepsi.gob.ar/api/worklist/create.php](https://pacs.cepsi.gob.ar/api/worklist/create.php)*
...
object
	...
	modalidad: string ['CR','MR','CT','US','DX','MG','NM','NN','RF']
	estudio: string
	apellido: string
	nombre: string
	dni: integer
...
**URL:** *[https://pacs.cepsi.gob.ar/api/worklist/list.php](https://pacs.cepsi.gob.ar/api/worklist/list.php)*
